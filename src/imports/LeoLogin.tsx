import svgPaths from "./svg-5bgws7fphr";
...
export default function LeoLogin() {
  return (
    <div className="bg-white relative size-full" data-name="Leo Login">
      ...
      <div className="-translate-x-1/2 -translate-y-1/2 absolute bg-[#4b5563] h-[122px] left-[calc(50%-0.5px)] overflow-clip top-[calc(50%-292px)] w-[392px]" data-name="Logo">
      ...
      <div className="absolute left-[-1.08px] top-[475px] w-[393px]" data-name="User Short Description">
        <div className="content-stretch flex flex-col gap-[23px] items-start leading-[normal] not-italic px-[50px] relative text-black w-full">
          <p className="capitalize font-['Inter:Bold',sans-serif] font-bold relative shrink-0 text-[32px] text-center w-full">Leo</p>
          <p className="capitalize font-['Inter:Bold',sans-serif] font-bold relative shrink-0 text-[18px] text-center w-full">Suboctractor</p>
          <p className="font-['Inter:Regular',sans-serif] font-normal h-[120.655px] relative shrink-0 text-[16px] w-full">Owns Patch Adams, a subcontractor repair company, providing availability for urgent National Highways repairs and submitting bids and required information for road section works.</p>
        </div>
      </div>
    </div>
  );
