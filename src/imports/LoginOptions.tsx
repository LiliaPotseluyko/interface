import svgPaths from "./svg-dn7e3tgty0";
...
export default function LoginOptions() {
  return (
    <div className="bg-white relative size-full" data-name="Login Options">
      ...
      <div className="-translate-x-1/2 -translate-y-1/2 absolute left-1/2 size-[185.761px] top-[calc(50%-43.12px)]" data-name="User">
        <div className="absolute left-0 size-[185.761px] top-0">
          <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 185.761 185.761">
            <circle cx="92.8806" cy="92.8806" fill="var(--fill-0, #E6EDF2)" id="Ellipse 15" r="89.0106" stroke="var(--stroke-0, #F7F9FB)" strokeWidth="7.74005" />
          </svg>
        </div>
        <div className="absolute inset-[8.72%_8.33%_7.95%_8.33%]" data-name="Vector">
          <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 154.801 154.801">
            <path clipRule="evenodd" d={svgPaths.p38f39300} fill="var(--fill-0, #F7F9FB)" fillRule="evenodd" id="Vector" />
          </svg>
        </div>
      </div>
      <div className="absolute h-[54px] left-[60.5px] top-[513.76px] w-[272px]" data-name="UserButton">
        <div className="absolute bg-white border-3 border-[rgba(75,85,99,0.5)] border-solid h-[53.774px] left-0 rounded-[8px] top-0 w-[272.038px]" />
        <p className="absolute font-['Inter:Regular',sans-serif] font-normal h-[21.052px] leading-[normal] left-[19.83px] not-italic text-[18px] text-[rgba(75,85,99,0.5)] top-[16.36px] w-[180.845px]">pick user persona</p>
        <div className="absolute bottom-[39.05%] right-[17.72px] top-[49.79%] w-[12px]" data-name="Vector">
          <div className="absolute inset-[-16.6%_-8.33%]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 14.0001 8.02524">
              <path d={svgPaths.p1beff200} fill="var(--fill-0, #4B5563)" fillOpacity="0.5" id="Vector" stroke="var(--stroke-0, #4B5563)" strokeLinejoin="round" strokeOpacity="0.5" strokeWidth="2" />
            </svg>
          </div>
        </div>
      </div>
      <div className="absolute bg-[#f7f9fb] content-stretch flex flex-col font-['Inter:Regular',sans-serif] font-normal gap-[10px] items-start leading-[normal] left-[74px] not-italic px-[15px] py-[10px] text-[#1e1e1e] text-[18px] top-[564px] w-[215px]" data-name="Options">
        <p className="relative shrink-0 w-full">Stephen</p>
        <p className="relative shrink-0 w-full">Samira</p>
        <p className="relative shrink-0 w-full">Rajesh</p>
        <p className="relative shrink-0 w-full">Leo</p>
      </div>
      <LoginButton className="-translate-x-1/2 absolute bg-[#7ba9d1] bottom-[64px] left-1/2 rounded-[6px] w-[153px]" property1="Inactive" />
      <div className="-translate-x-1/2 -translate-y-1/2 absolute bg-[#4b5563] h-[122px] left-[calc(50%-0.5px)] overflow-clip top-[calc(50%-292px)] w-[394px]" data-name="Logo">
      ...
      <div className="-translate-y-1/2 absolute capitalize flex flex-col font-['Inter:Bold',sans-serif] font-bold justify-center leading-[0] left-[calc(50%-43.5px)] not-italic text-[#4b5563] text-[32px] top-[calc(50%-154.5px)] whitespace-nowrap">
