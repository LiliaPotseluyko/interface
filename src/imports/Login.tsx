import svgPaths from "./svg-rgqq1fxne0";
...
export default function Login() {
  return (
    <div className="bg-white relative size-full" data-name="Login">
      ...
      <LoginButton className="-translate-x-1/2 absolute bg-[#7ba9d1] bottom-[58px] left-1/2 rounded-[6px] w-[153px]" property1="Inactive" />
      <div className="-translate-y-1/2 absolute bg-[#4b5563] h-[122px] left-[-0.25%] overflow-clip right-0 top-[calc(50%-292px)]" data-name="Logo">
