import svgPaths from "./svg-qdo1wtt5l9";
...
export default function RajeshLogin() {
  return (
    <div className="bg-white relative size-full" data-name="Rajesh Login">
      ...
      <div className="absolute left-[-1.08px] top-[475px] w-[393px]" data-name="User Short Description">
        <div className="content-stretch flex flex-col gap-[23px] items-start leading-[normal] not-italic px-[50px] relative text-black w-full">
          <p className="capitalize font-['Inter:Bold',sans-serif] font-bold relative shrink-0 text-[32px] text-center w-full">Rajesh</p>
          <p className="capitalize font-['Inter:Bold',sans-serif] font-bold relative shrink-0 text-[18px] text-center w-full">Contractor</p>
          <p className="font-['Inter:Regular',sans-serif] font-normal h-[120.655px] relative shrink-0 text-[16px] w-full">Focuses on planning and preparing bids for subcontractors for non-urgent repair works using RoadGP decision support.</p>
        </div>
      </div>
    </div>
  );
