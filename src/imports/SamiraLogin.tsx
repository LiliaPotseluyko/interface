import svgPaths from "./svg-co31aa426m";
import imgEllipse15 from "figma:asset/00d92993a3dec5f72c836288e055af5e76414806.png";
...
export default function SamiraLogin() {
  return (
    <div className="bg-white relative size-full" data-name="Samira Login">
      ...
      <div className="-translate-x-1/2 -translate-y-1/2 absolute bg-[#4b5563] h-[122px] left-1/2 overflow-clip top-[calc(50%-292px)] w-[393px]" data-name="Logo">
      ...
      <div className="absolute left-[-1.08px] top-[475px] w-[393px]" data-name="User Short Description">
        <div className="content-stretch flex flex-col gap-[23px] items-start leading-[normal] not-italic px-[50px] relative text-black w-full">
          <p className="capitalize font-['Inter:Bold',sans-serif] font-bold relative shrink-0 text-[32px] text-center w-full">Samira</p>
          <p className="capitalize font-['Inter:Bold',sans-serif] font-bold relative shrink-0 text-[18px] text-center w-full">{`Manager `}</p>
          <p className="font-['Inter:Regular',sans-serif] font-normal h-[120.655px] relative shrink-0 text-[16px] w-full">Works at National Highways, reviewing assessors’ work and performance, monitoring AI performance and assurance, and overseeing completion of repair work by contractors and subcontractors.</p>
        </div>
      </div>
    </div>
  );
