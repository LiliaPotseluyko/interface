...
import { ArrowLeft, Wrench, TrendingUp, ChevronLeft, ChevronRight, Map, Eye, Camera } from 'lucide-react';
...
// Mock data - in real app would fetch based on section ID
    ...
    <div className="min-h-screen bg-gray-50 ml-64">
      ...
      <header className="bg-white border-b border-gray-200 px-4 py-3">
        <div className="flex items-center gap-3 mb-3">
          <button
            onClick={() => navigate(`/persona/${personaId}/roads`)}
        ...
        <div className="bg-white rounded-lg p-4 border border-gray-200">
          <div className="space-y-3">
            <div className="flex items-center justify-between">
              ...
              <span className={`font-bold px-3 py-1 rounded-full text-sm ${getConditionColor(section.condition)}`}>
                {section.condition}
              </span>
            </div>
            <div className="flex items-center justify-between">
